...
select, button {
    padding: 15px 20px; /* Zwiększenie paddingu dla większego przycisku */
    font-size: 16px;
    margin: 10px;
    border: none;
    border-radius: 5px;
    ...
    color: #FFF5E0;
    cursor: pointer;
    transition: background-color 0.3s; /* Dodanie płynności przy hoverze */
}
...
h3 {
    font-size: 24px; /* Zwiększenie rozmiaru czcionki dla pytania */
}
